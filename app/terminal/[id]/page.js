...
export default function TerminalPage() {
    ...
    return (
        <div className="h-screen bg-neutral-950 flex flex-col overflow-hidden">
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        <div className="w-7 h-7 md:w-8 md:h-8 bg-primary/20 rounded-lg flex items-center justify-center">
                            <TerminalIcon className="text-primary w-4 h-4 md:w-5 md:h-5" />
                        </div>
                        <h1 className="font-semibold text-sm md:text-lg whitespace-nowrap">SSH Terminal</h1>
                    </div>
                </div>
            ...
            <main className="flex-1 p-2 md:p-4 bg-neutral-950 relative overflow-hidden">
            ...
            <footer className="h-8 border-t border-neutral-800 bg-neutral-900/20 px-4 md:px-6 flex items-center justify-between text-[8px] md:text-[10px] text-neutral-600 font-mono tracking-wider uppercase">
                <span className="truncate mr-4">Connected: UnifiedSSH v1.0.0</span>
